...
class EditRuralProducerService:
    ...
    def __init__(
        ...
        if self.__rural_producer_schema.document_number:
            self.__rural_producer_schema.document_number = clean_numerical_string(
                self.__rural_producer_schema.document_number
            )
    ...
    def __update_rural_producer(self, rural_producer: RuralProducer) -> RuralProducer:
        ...
        if self.__rural_producer_schema.document_number is not None:
            rural_producer.document_number = clean_numerical_string(
                self.__rural_producer_schema.document_number
            )
    ...
    def __update_farm(
        self, farm: Optional[FarmRuralProducer]
    ) -> Optional[FarmRuralProducer]:
        if farm is None:
            return farm
        ...
        if self.__rural_producer_schema.farm.total_hectare_area is not None:
            farm.total_hectare_area = (
                self.__rural_producer_schema.farm.total_hectare_area
            )

        if self.__rural_producer_schema.farm.arable_hectare_area is not None:
            farm.arable_hectare_area = (
                self.__rural_producer_schema.farm.arable_hectare_area
            )

        if self.__rural_producer_schema.farm.vegetation_hectare_area is not None:
            farm.vegetation_hectare_area = (
                self.__rural_producer_schema.farm.vegetation_hectare_area
            )
    ...
    def __validate(self, rural_producer_model: RuralProducer):
        ...
        document_to_validate = (
            self.__rural_producer_schema.document_number
            if self.__rural_producer_schema.document_number
            else rural_producer_model.document_number
        )
        document_type_to_validate = (
            self.__rural_producer_schema.document_type
            if self.__rural_producer_schema.document_type
            else rural_producer_model.document_type
        )
        ...
        arable_hectare_area = (
            self.__rural_producer_schema.farm.arable_hectare_area
            if self.__rural_producer_schema.farm.arable_hectare_area is not None
            else rural_producer_model.farm.arable_hectare_area
        )
        vegetation_hectare_area = (
            self.__rural_producer_schema.farm.vegetation_hectare_area
            if self.__rural_producer_schema.farm.vegetation_hectare_area is not None
            else rural_producer_model.farm.vegetation_hectare_area
        )
        total_hectare_area = (
            self.__rural_producer_schema.farm.total_hectare_area
            if self.__rural_producer_schema.farm.total_hectare_area is not None
            else rural_producer_model.farm.total_hectare_area
        )
