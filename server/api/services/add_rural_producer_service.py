...
class AddRuralProducerService:
    ...
    def __init__(
        ...
        if self.rural_producer_schema.document_number:
            self.rural_producer_schema.document_number = clean_numerical_string(
                self.rural_producer_schema.document_number
            )
    ...
    def __validate(self):
        try:
            rural_producer_already_registered = (
                self.__rural_producer_repository.get_by_document(
                    self.rural_producer_schema.document_number
                )
            )
        ...
        culture_type_ids = [
            culture.farm_culture_type_id
            for culture in self.rural_producer_schema.farm.cultures
        ]
