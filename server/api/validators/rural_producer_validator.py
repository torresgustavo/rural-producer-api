...
class RuralProducerValidator():
    ...
    def validate_document(self, document_type: str, document_number: str, rural_producer_editing: Optional[RuralProducer] = None):
        ...
        try:
            rural_producer_registered = self.__rural_producer_repository.get_by_document(document_number)
            if rural_producer_editing and rural_producer_registered.id != rural_producer_editing.id:
                raise self.__create_validation_error(
                    valid=False,
    ...
    def validate_farm_area(self, total_hectare_area: Decimal, arable_hectare_area: Decimal, vegetation_hectare_area: Decimal):
    ...
    def validate_cultures(self, cultures_type_id_list: List[int]) -> None:
        ...
        for culture_type_id in cultures_type_id_list:
            ...
            repeated_culture = list(filter(lambda culture_type_id: culture_type_id == culture.get('id'), cultures_type_id_list))
