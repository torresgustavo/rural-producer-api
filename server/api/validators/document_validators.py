...
class DocumentsValidator:
    ...
    def __cpf_validator(self) -> bool:
        ...
        if (
            int(self.__document_number[9]) == first_digit
            and int(self.__document_number[10]) == second_digit
        ):
            return True
        else:
            return False
    ...
    def __cnpj_validator(self) -> bool:
        ...
        return (
            int(self.__document_number[12]) == digit1
            and int(self.__document_number[13]) == digit2
        )
